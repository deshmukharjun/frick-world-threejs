...
// Load the moon texture and create the sphere (moon)
...
// Set up the Effect Composer with RenderPass and UnrealBloomPass
...
// Group for images around the moon
const imageGroup = new THREE.Group();
scene.add(imageGroup);

// Attach an image to the image group
...
// Define parameters for the sphere and image grid
...
// Set up raycaster for hover effect
